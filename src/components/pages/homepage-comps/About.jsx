    ...
    return (
        ...
        className='relative w-full md:h-screen text-white h-unset'>
            ...
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg'>
                    ...
                    <p className="mb-3 py-6"> I hold a B.Tech in Computer Science and Engineering from PSIT Kanpur and completed my schooling at Kendriya Vidyalaya No. 2 in Armapur. Professionally, I have gained valuable experience as a Web Developer at Zidio Development, where I honed my skills in both front-end and back-end technologies and contributed to numerous successful projects.</p>
                    <p className="mb-7 py-3"> Outside of work, I enjoy playing football, which has helped me develop teamwork and strategic thinking, and watching English movies, which reflects my interest in language, culture, and storytelling</p>
